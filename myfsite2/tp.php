...
echo "<tr><td> <input type=submit name=submit class='btn btn-success' value='Next Question'><td> <input type=submit name=submit class='btn btn-danger' value='Close Test'></form>";
if(($_SESSION[qn]==mysql_num_rows($rs)-1)&&($p==0)){
 ...
 <div class="col-sm-2">
  <div class="row">
    <div class="panel panel-primary">
      <div class="panel-heading"><h4 align="center">Question Reveiw</h4></div>
